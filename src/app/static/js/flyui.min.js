...
(function e(t, n, r) {
        ...
        function(require, module, exports) {
            ...
            var Component = fly.ObservableObject.extend({
                ...
                ctor: function(element, options, cache) {
                    ...
                    // 鎵╁睍 options
                    // 鍥犱负 dataSource 姣旇緝鐗规畩锛屼笉鍙備笌 extend
                ...
                /**
                 * 灏嗗厓绱犵殑 tabindex 杞Щ鍒扮粍浠朵笂
                 * @param  {Object} target 鐩爣鍏冪礌
                 */
    ...
    4: [
        function(require, module, exports) {
            ...
            Class.extend = function(prop) {
                ...
                // 鐖剁被鐨勫疄渚嬭祴缁欏彉閲弍rototype
                var prototype = new this();

                // 鎶婅鎵╁睍鐨勫睘鎬у鍒跺埌prototype鍙橀噺涓�
                for (var name in prop) {
                    // this._super璁块棶鐖剁被鐨勫疄渚�
                    // name == CTOR
                    prototype[name] = typeof prop[name] == FUNCTION &&
                        ...
                        return function() {
                            ...
                            // 姝ゆ椂fn涓殑this閲岄潰鐨則his._super宸茬粡鎹㈡垚浜哶super[name],鍗崇埗绫荤殑鍚屽悕鏂规硶
                ...
                // 浠讳綍Class.extend鐨勮繑鍥炲璞￠兘灏嗗叿澶噀xtend鏂规硶
            ...
            /**
             * 鏋勫缓琛ㄨ揪寮�
             * @param   {String}  [expression=''] 鍘熷琛ㄨ揪寮�
             * @param   {Boolean} safe            鏄惁瀹夊叏鏋勫缓
             * @param   {String}  paramName       鍙傛暟鍚�
             * @returns {String}  瑙ｆ瀽鍚庣殑琛ㄨ揪寮�
             */
            ...
            /**
             * 鍙栧€�
             * @param   {String}   expression 琛ㄨ揪寮�
             * @param   {String}   safe       key
             * @returns {Function} 瑙ｆ瀽琛ㄨ揪寮忕殑鍑芥暟
             */
            ...
            /**
             * 鏋勫缓璇诲彇灞炴€у€肩殑琛ㄨ揪寮�
             * @param   {Array}  members   鎴愬憳 ['a', 'b'] ==> ((d.a || {}).b)
             * @param   {String} paramName 鍙傛暟鍚�
             * @returns {String} 鎷艰濂界殑琛ㄨ揪寮�
             */
        ...
        function(require, module, exports) {
            ...
            var DataSource = Observable.extend({
                ...
                ctor: function(options) {
                    ...
                    that._prefetch = {}; // 棰勬媺鍙�
                    that._data = []; // 鍒濆鏁版嵁
                    that._pristineData = []; // 鍏抽敭鏁版嵁
                    that._ranges = [];
                    that._view = [];
                    that._pristineTotal = 0;
                    that._destroyed = []; // 宸查攢姣�
                    that._pageSize = options.pageSize;
                    that._page = options.page || (options.pageSize ? 1 : undefined); // 褰撳墠椤电爜
                 ...
                 * 鑾峰彇item
                 * @param   {String} id          鍊�
                 * @param   {String} [key='id',] 瀛楁鍚�
                 * @returns {Object} 绗﹀悎鏉′欢鐨刣ata
                 */
                get: function(id, key) {
                    var data = this._data,
                        key = key || 'uid',
            ...
            var DataReader = Class.extend({
                ...
                parse: function(data) {
                    // 鏄惁瀵规棤鏁版嵁鐨勬儏鍐佃繘琛岃繃婊わ紝杩欐槸涓€涓ぇ鍧�
            ...
            /**
             * 灏嗘暟鎹浆鍖栦负甯︽湁index鐨凧SON Object
             * @param   {Array}  array 闇€瑕佹牸寮忓寲鐨勬暟缁�
             * @returns {Object} JSON
             */
    ...
    6: [
        function(require, module, exports) {
             ...
             * @param   {String} format 鏍煎紡鍖栧弬鏁�
             * @returns {String} 鏍煎紡鍖朌ate
             */
            ...
            /**
             * 灏嗗瓧绗︿覆杞负鏃ユ湡
             * @param   {String} value   闇€瑕佹牸寮忓寲鐨勬椂闂村瓧绗︿覆 鎴栬€� Date
             * @param   {String} formats 鏍煎紡
    ...
    11: [
        function(require, module, exports) {
            ...
            var Observable = Class.extend({
                ...
                /**
                 * 娉ㄥ唽鐩戝惉浜嬩欢
                 * @param  {String}   eventName 浜嬩欢鍚嶇О锛屽彲浠ユ槸瀛楃涓叉垨鏁扮粍
                 * @param  {Function} handlers  浜嬩欢锛屽彲浠ユ槸鍑芥暟鎴栧嚱鏁癿ap
                 * @param  {Boolean}  one       鏄惁鍙墽琛屼竴娆�
                 * @return {Object}   瑙傚療鑰呭璞�
                 */
                 ...
                 * 娉ㄩ攢浜嬩欢
                 * @param  {String}   eventName 浜嬩欢鍚嶇О
                 * @param  {Function} handler   浜嬩欢 鍚屼竴涓簨浠跺悕绉板彲鑳芥湁濂藉嚑涓簨浠讹紝
                 *                              杩欓噷鍙互鍙敞閿€鍏朵腑涓€涓�
                 * @return {Object}   瑙傚療鑰呭璞�
                 */
            ...
            /**
             * 浜嬩欢澶勭悊鍣�
             * @param   {Object}   context 浜嬩欢涓婁笅鏂�
             * @param   {String}   type    浜嬩欢鍚嶇О
             * @param   {String}   field   瀛楁鍚�
             * @param   {Boolean}  prefix  鏄惁闇€瑕侀澶勭悊
        ...
        function(require, module, exports) {
            (function(global) {
                ...
                support.touch = (
                    ...
                    (global.DocumentTouch && document instanceof global.DocumentTouch) || //闈濱E
    ...
    15: [
        function(require, module, exports) {
            ...
            /**
             * 妯℃澘
             * @param   {String} filename 妯℃澘鍚�
             * @param   {Object, String} content  鏁版嵁 濡傛灉涓哄瓧绗︿覆鍒欑紪璇戝苟缂撳瓨缂栬瘧缁撴灉
             * @returns {String, Function} 娓叉煋濂界殑HTML瀛楃涓叉垨鑰呮覆鏌撴柟娉�
             */
    ...
    16: [
        function(require, module, exports) {
             ...
             * @return {String} 鍙傛暟鍊硷紝鑻ユ病鏈夎鍙傛暟锛屽垯杩斿洖''
             */
             ...
             * 鍗冲皢搴熷純
             * 鑾峰彇鏈€楂樺眰绾х殑window
             * @returns {Object} 寮曠敤flyui鐨勬渶楂樺眰绾х殑window瀵硅薄
             */
            fly.top = function() {
                var top = window,
                    test = function(name) {
                        var doc;
                        try {
                            doc = window[name].document; // 璺ㄥ煙|鏃犳潈闄�
            ...
            /**
             * 鑾峰彇璁＄畻鍚庣殑鏍峰紡锛堟渶缁堜娇鐢ㄧ殑CSS灞炴€у€硷級
             * @param   {Object} element    DOM
             * @param   {Array}  properties 灞炴€�
             * @returns {Object} 鏍峰紡瀵硅薄
             */
             ...
             * 鏄惁鍙粴鍔�
             * @param   {Object}  element DOM
             * @returns {Boolean} 鏄垯鏀寔锛屽惁鍒欎笉鏀寔
             */
            ...
            /**
             * 鍑芥暟鑺傛祦
             * 鍒涘缓骞惰繑鍥炰竴涓儚鑺傛祦闃€涓€鏍风殑鍑芥暟锛屽綋閲嶅璋冪敤鍑芥暟鐨勬椂鍊欙紝鏈€澶氭瘡闅� wait 姣璋冪敤涓€娆¤鍑芥暟銆�
             * 瀵逛簬鎯虫帶鍒朵竴浜涜Е鍙戦鐜囪緝楂樼殑浜嬩欢鏈夊府鍔┿€�
             * 濡傛灉浣犳兂绂佺敤绗竴娆￠鍏堟墽琛岀殑璇濓紝浼犻€� {leading: false}
             * 杩樻湁濡傛灉浣犳兂绂佺敤鏈€鍚庝竴娆℃墽琛岀殑璇濓紝浼犻€� {trailing: false}
             * 鏉ヨ嚜underscore
             * @param   {Function} func    瑕佹墽琛岀殑鍑芥暟
             * @param   {Number}   wait    棰戝害鏃堕棿
             * @param   {Object}   options 閰嶇疆鍙傛暟
             * @returns {Function} 宸茶妭娴佺殑鍑芥暟
             */
            ...
            /**
             * 鍑芥暟闃插弽璺�
             * 灏嗗欢杩熷嚱鏁扮殑鎵ц(鐪熸鐨勬墽琛�)鍦ㄥ嚱鏁版渶鍚庝竴娆¤皟鐢ㄦ椂鍒荤殑 wait 姣涔嬪悗
             * 鏉ヨ嚜underscore
             * @param   {Function} func        瑕佹墽琛岀殑鍑芥暟
             * @param   {Number}   wait        绛夊緟鐨勬椂闂�
             * @param   {Boolean}  [immediate] 涓� true 鏃朵細鍦� wait 鏃堕棿闂撮殧鐨勫紑濮嬭皟鐢ㄨ繖涓嚱鏁�
             * @returns {Function} 鍑芥暟鐨勯槻鍙嶈烦鐗堟湰
             */
            ...
            /**
             * 瑙ｆ瀽鍏冪礌鎸囧畾鐨勫睘鎬у€�
             * @param   {Object} element 鍏冪礌
             * @param   {String} option  灞炴€�
             * @returns {Any}    瑙ｆ瀽鍚庣殑鍊�
             */
             ...
             * 瑙ｆ瀽鍏冪礌灞炴€у€�
             * @param   {Object} element 鍏冪礌
             * @param   {Object} options 闇€瑕佽В鏋愮殑鍙傛暟
             * @returns {Object} 瑙ｆ瀽鍚庣殑鍊�
             */
            ...
            /**
             * 璁＄畻瀛楃涓茬殑瀛楄妭闀垮害
             * @param   {String} str 闇€瑕佽绠楅暱搴︾殑瀛楃涓�
             * @returns {Number} 瀛楄妭闀垮害
             */
